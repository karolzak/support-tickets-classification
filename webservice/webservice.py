...
# Loading models
model_impact = pickle.load( open( os.path.join(__location__, "impact.model"), "rb" ) )
model_ticket_type = pickle.load( open(os.path.join(__location__, "ticket_type.model"), "rb" ) )
model_category = pickle.load( open(os.path.join(__location__,  "category.model"), "rb" ) )
#model_urgency = pickle.load( open( os.path.join(__location__, "urgency.model"), "rb" ) )
#model_business_service = pickle.load( open(os.path.join(__location__, "business_service.model"), "rb" ) )
